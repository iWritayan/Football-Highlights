//
//  VerticalHighlightView_Previews.swift
...
extension VerticalHighlightView_Previews {
    ...
    static var snapshots: PreviewSnapshots<RecentMatch> {
        PreviewSnapshots(
            ...
            configure: { state in
                VerticalHighlightView(viewModel: DefaultRecentMatchListItemViewModel(matchdata: state)).padding()
            }
        )
    }
}
